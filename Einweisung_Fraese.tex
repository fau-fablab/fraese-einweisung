...
\begin{itemize}
 \item Not-Aus vorne an der Fräse: Funktioniert immer, die Spindel läuft aber noch nach.
...
\clearpage
\section{Wartung und Vorbereitung der Maschine}
...
\begin{itemize}
	\item auf gleichmäßigen Luftaustritt kreisförmig unten an der Spindel prüfen (\cref{fig:hsk-aufnahme}, gelb)
	\item warmlaufen
...
\subsection{14tägig}
An allen HSK-Einsätzen die Kegel- und Planfläche (siehe \cref{fig:hsk-einsatz})
\begin{itemize}
	...
	\item \emph{Nicht} die HSK-Aufnahme an der Spindel einsprühen, nur die Einsätze.
\end{itemize}
...
\begin{itemize}
	...
	\item Segmente des Greifers in der Mitte der HSK-Aufnahme (\cref{fig:hsk-greifer}) damit schmieren (graue Flüssigkeit)
...
\begin{itemize}
	...
	\item Fräser einspannen, möglichst kurz und fest einspannen, dabei passende Spannzange verwenden.
\end{itemize}
...
Während des Vorheizens müssen die Türen geschlossen bleiben. ) % TODO bei neuer Spindel mit automatischem Wkzw. müssen wir wohl immer ein Werkzeug drinhaben.
