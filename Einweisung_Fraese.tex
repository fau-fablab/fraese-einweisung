...
\begin{enumerate}
	...
	\item Wenn dazu aufgefordert wird (unten im Fenster), STRG-G drücken um den Vorgang abzuschließen
\end{enumerate}
...
Es geht nur ein Werkzeug pro Datei. Neue Datei laden, Werkzeugwechsel und Längenmessung wie oben beschrieben, starten.

\emph{Mehrere Werkzeuge pro Datei sind nicht erlaubt, weil es damit noch bekannte Probleme und Gefahren gibt, insb. verwirrende Meldungen und die Gefahr dass die falsche Werkzeuglänge genutzt wird.}
