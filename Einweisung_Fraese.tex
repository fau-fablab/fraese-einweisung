...
\begin{itemize}
	\item \knopf{OK}, neue Werkzeugnummer eingeben, \knopf{OK}
	\item Weitere Dialoge durchgehen. Dabei muss beachtet werden: 
	\begin{enumerate}
		\item Die Werkzeugnummer 0 bedeutet \enquote{kein Werkzeug}
		\item Der Werkzeugdurchmesser darf nicht Null sein
		\item Dezimalbrüche werden mit Punkt statt Komma eingegeben!
		\item Nachdem in der kleinen Konsole eine Ausgabe beginnend mit \enquote{Action...} kommt, die Tür schließen und mit STRG-G bestätigen
	\end{enumerate}
	...
	\item Maschinentüre schließen
	\item STRG-G drücken um den Vorgang abzuschließen
\end{itemize}
	\item Wenn noch nicht geschehen, Werkzeuglänge messen  (\knopf{User} $\rightarrow$ \knopf{Wkz.länge})
\end{enumerate}
