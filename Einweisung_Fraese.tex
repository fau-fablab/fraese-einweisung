...
Während des Vorheizens müssen die Türen geschlossen bleiben.
 ...
 \item Es muss eine Meldung \enquote{Werkzeug bereits geladen, trotzdem wechseln?} kommen. Diese mit Nein beantworten und die Info \enquote{Es wurde nicht gewechselt} bestätigen. 
 
 Wenn stattdessen ein Dialog mit alter und neuer Werkzeugnummer kommt, dann sofort abbrechen und den kompletten Einrichtvorgang (Werkzeug wechseln, Länge, Z-Null) wiederholen.
