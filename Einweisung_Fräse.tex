...
\begin{enumerate}
 ...
 \item Jetzt sollte man bereits die richtige Werkzeugnummer für das erste Werkzeug im Job haben (Anzeige: T17), sonst User-Button \knopf{Manueller Wkz.wechsel} und dann \knopf{Reset}
...
\textbf{Automatischer Werkzeugwechsel ist momentan nicht möglich, daher neue Datei laden und wie bei Einrichten (\ref{einrichten}) $\rightarrow$ Werkzeug einspannen  weiter.}
